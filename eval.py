...
flags.DEFINE_string('eval_logdir','./eval_res', 'Where to write the event logs.')

flags.DEFINE_string('checkpoint_dir', './model', 'Directory of model checkpoints.')
...
flags.DEFINE_list('eval_crop_size', '801,801',
